...
package gs {
	...
	public class TweenMax extends TweenFilterLite {
		public static var version:Number = 1.16;
...
//---- PROXY FUNCTIONS ------------------------------------------------------------------------------------------------------------
		...
		/* potential new feature - slerp quaternion tweening for 3D stuff
		public static function quaternionProxy($o:Object):void {
			var info:Object = $o.info;
			var t:Number = $o.target.t;
			var tg:* = info.target;
			var scale:Number, invScale:Number;
