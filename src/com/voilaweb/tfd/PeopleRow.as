package com.voilaweb.tfd
{
	...
	public class PeopleRow extends HBox
	{
		...
		public function PeopleRow(app:TwitterifiedNative, person:TwitterUser)
		{
			//styleName = 'statusrow';
			++ _idrunner;	
		...
		private function onComplete(event:Event):void
		{
			...
			myWrapper.addEventListener(MouseEvent.CLICK, onImageMouseClick);
		}
